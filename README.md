...
현재 등록 프로젝트는 GameYob Custom `v0.5.10`, GBARunner3 Custom `custom-v0.1.3`, NitroSwan Custom `v0.7.7-custom.r8`, 테일즈 오브 더 월드 나리키리 던전2 `v0.9d`, 테일즈 오브 더 월드 나리키리 던전3 `v1.1a`, AI Work Skills `v2026.09.19.2` 여섯 개입니다. 기본 정보는 정적 JSON이 기준이며 프로젝트 정보와 웹 패처는 GitHub API에 의존하지 않습니다.
