...
GameYob·GBARunner3·NitroSwan은 원 저장소의 Issues가 비활성화되어 있어 `reportRepository`를 포털 저장소로 지정합니다. 웹 양식에 프로젝트 식별 주석을 넣고 현황 조회에서 해당 주석으로 필터링합니다. 한글 패치·AI Work Skills는 각 저장소의 공개 이슈를 조회합니다. 신규 프로젝트는 이슈 활성화 여부를 확인하고 같은 규칙을 적용합니다.
