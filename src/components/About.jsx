...
const principles = [
  { icon: Archive, title: '개인 프로젝트 아카이브', text: '한국어화 패치, 에뮬레이터·호환 계층과 AI 작업 도구의 설치·사용 정보와 변경 기록을 정리합니다.' },
  { icon: Code2, title: '프로젝트별 사용 방법', text: '한글 패치는 웹 패처로 적용하고, 에뮬레이터·호환 계층은 배포 버전을 선택해 받으며, AI 작업 도구는 저장소에서 설치합니다.' },
